 ...
 */
@Controller
public class YYHCController {


    private static final String hostUrl = "https://tts-api.xfyun.cn/v2/tts"; //http url 不支持解析 ws/wss schema
    private static final String appid = "6018d7f6";//到控制台-语音合成页面获取
    private static final String apiSecret = "0a936ec60be42cb0a55a6b88f8aabe52";//到控制台-语音合成页面获取
    private static final String apiKey = "6280687b7006e1612e2b635078510fa9";//到控制台-语音合成页面获取
    ...
    public static String wzToyy() throws Exception {
        // 构建鉴权url
        ...
        File f = new File("E:\\interesting\\sushe\\yysb\\target\\classes\\static\\" + date + ".mp3");
        if (!f.exists()) {
            f.createNewFile();
        }
                ...
                if (resp != null) {
                    ...
                    if (resp.getData() != null) {
                        ...
                        if (resp.getData().status == 2) {
                            ...
                            System.out.println("合成的音频文件保存在：" + f.getAbsolutePath());
